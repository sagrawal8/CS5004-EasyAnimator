...
public class AnimationReader {
   ...
   * @param <EasyAnimatorModel> The main model interface type describing animations
   * @return
   */
  public static <EasyAnimatorModel> EasyAnimatorModel parseFile(
      Readable readable, AnimationBuilder<EasyAnimatorModel> builder) {
  ...
  private static <EasyAnimatorModel> void readCanvas(
      Scanner s, AnimationBuilder<EasyAnimatorModel> builder) {
    int[] vals = new int[4];
  ...
  private static <EasyAnimatorModel> void readShape(
      Scanner s, AnimationBuilder<EasyAnimatorModel> builder) {
    String name;
    String type;
    if (s.hasNext()) {
  ...
  private static <EasyAnimatorModel> void readMotion(
      Scanner s, AnimationBuilder<EasyAnimatorModel> builder) {
    String[] fieldNames =
        new String[] {
          "initial time",
